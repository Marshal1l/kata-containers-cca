...
type MachineConfiguration struct {
	...
	// realm config
	RealmConfig *RealmConfig `json:"realm_config,omitempty"`
...
func (m *MachineConfiguration) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRealmConfig(formats); err != nil {
		res = append(res, err)
	}
...
func (m *MachineConfiguration) validateRealmConfig(formats strfmt.Registry) error {
	if swag.IsZero(m.RealmConfig) { // not required
		return nil
	}

	if m.RealmConfig != nil {
		if err := m.RealmConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("realm_config")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("realm_config")
			}
			return err
		}
	}
...
func (m *MachineConfiguration) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRealmConfig(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *MachineConfiguration) contextValidateRealmConfig(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.RealmConfig != nil {
		...
		if err := m.RealmConfig.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("realm_config")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("realm_config")
